...
#define RECIPE_SLOT_QWEN_PROJ 17
#define RECIPE_SLOT_QWEN_GATE 18
#define RECIPE_SLOT_QWEN_ALPHA 19
#define RECIPE_SLOT_QWEN_BETA 20
...
typedef enum {
	...
	OP_QWEN_SPLIT_QGATE,
	OP_QWEN_PARTIAL_ROPE_QK,
	OP_QWEN_ATTN_GATE,
	OP_QWEN_GATED_DELTA_NET,
