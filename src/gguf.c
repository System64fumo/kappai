...
static const ggml_type_info *ggml_type_lookup(uint32_t t) {
	static const ggml_type_info table[] = {
		...
		[GGML_TYPE_Q2_K]	  = {GGML_TYPE_Q2_K, "q2_K", 84, 256},
		...
		[GGML_TYPE_IQ2_XXS]	  = {GGML_TYPE_IQ2_XXS, "iq2_xxs", 66, 256},
		[GGML_TYPE_IQ2_XS]	  = {GGML_TYPE_IQ2_XS, "iq2_xs", 74, 256},
		[GGML_TYPE_IQ3_XXS]	  = {GGML_TYPE_IQ3_XXS, "iq3_xxs", 98, 256},
		[GGML_TYPE_IQ1_S]	  = {GGML_TYPE_IQ1_S, "iq1_s", 50, 256},
		[GGML_TYPE_IQ4_NL]	  = {GGML_TYPE_IQ4_NL, "iq4_nl", 18, 32},
		[GGML_TYPE_IQ3_S]	  = {GGML_TYPE_IQ3_S, "iq3_s", 110, 256},
		[GGML_TYPE_IQ2_S]	  = {GGML_TYPE_IQ2_S, "iq2_s", 82, 256},
		[GGML_TYPE_IQ4_XS]	  = {GGML_TYPE_IQ4_XS, "iq4_xs", 136, 256},
		[GGML_TYPE_IQ1_M]	  = {GGML_TYPE_IQ1_M, "iq1_m", 56, 256},
		...
		[GGML_TYPE_Q4_K_R8]	 = {GGML_TYPE_Q4_K_R8, "q4_K_r8", 144, 256},
	};
